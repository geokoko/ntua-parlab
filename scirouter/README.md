...
| `ORION_HOME` | Your absolute home directory path on Orion. | `/home/users/s0123456` |
| `SCIROUTER_SHARED` | The absolute path to the shared directory on SciRouter. | `/mnt/panfs/users/s0123456` |
| `LOCAL_PARALLEL` | The absolute path to the root of your local repository. | `/home/user/ntua-parallel-processing-systems` |
| `EXERCISE_DIRS` | Space-separated list of directories to sync (relative to repo root). | `a1 a2 a3 a4` |
