...
int main(int argc, char **argv)
{
    ...
    */
    ...
    if (rank == 0) {
        ...
        // Each rank takes minimum base Objects
        // And the rest (where rest = numObjs % size) are distributed to the rest first ranks
     ...
     */
    // Broadcasting recvcounts and displs arrays to other rankes
     ...
     */
    // Rank 0 gathers all the membership information (all ranks run this code)
